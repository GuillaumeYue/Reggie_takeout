...
import com.finalPrj.reggie.mapper.CategoryMapper;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements CategoryService {
    ...
    public void remove(Long ids) {
        ...
        if (count1 > 0) {
            //已经关联菜品，抛出一个业务异常
            throw new CustomException("Current category linked to dish, unable to delete!");
        }
        ...
        if (count2 > 0) {
            //已经关联套餐，抛出一个业务异常
            throw new CustomException("Current category linked to set meal, unable to delete!");
        }
        //正常删除分类
